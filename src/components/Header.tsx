...
export default function _() {
  return (
    <header className="w-full border-b border-neutral-700">
      <div className="flex gap-4 justify-between items-center text-xl py-8 px-8 max-w-screen-2xl mx-auto">
        <section className="flex flex-col gap-2 justify-center items-start">
          <Link href="/" className="text-neutral-50 text-base sm:text-3xl">Web Inspirations</Link>
